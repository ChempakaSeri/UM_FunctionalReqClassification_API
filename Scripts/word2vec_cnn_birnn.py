...
mld = 'C:/Users/Ameer/Documents/UM_FunctionalReqClassification_API/Model/word2vec_cnn_birnn_balanced.hdf5'
...
print('Training the Word2Vec CNN + Bi-RNN model')
...
plt.plot(epochs_range_4, acc_4, 'bo', label='Training acc')
plt.plot(epochs_range_4, val_acc_4, 'b', label='Validation acc')
plt.title('Training and validation accuracy')
plt.legend()

plt.figure()

plt.plot(epochs_range_4, loss_4, 'bo', label='Training loss')
plt.plot(epochs_range_4, val_loss_4, 'b', label='Validation loss')
